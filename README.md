...
[![Deploy to Cloudflare](https://deploy.workers.cloudflare.com/button)](https://deploy.workers.cloudflare.com/?url=https://github.com/cloudflare/templates/tree/main/patient-field-fc6c)
...
```
npm create cloudflare@latest -- --template=cloudflare/templates/patient-field-fc6c
```

A live public deployment of this template is available at [https://patient-field-fc6c.templates.workers.dev](https://patient-field-fc6c.templates.workers.dev)
